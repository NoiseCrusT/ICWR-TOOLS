...
sleep 1
echo ""
echo -e $green"[#]> WELCOME TO ICWR TOOLS ... "
sleep 1
echo ""
echo -e $white"[#]> NoXLaw Wuzz Here ... "
read enter
exit
}


echo -e $red"           __  ___     _____     __    _ __"
echo -e $red"          /  |/  /___ / ___/__ _/ /__ (_) /"
echo -e $white"         / /|_/ / __// /__/  _ /   _// / / "
echo -e $white"        /_/  /_/_/ (_)___/\_,_/_/\_\/_/_/  "
echo -e $red"         ***********************************************"
echo -e $white"         # $red We Are Bad People In ICWR         $white           #"
echo -e $red"         # $red We Are Anonim                $red             #"
echo -e $white"         # $red contact me: islahelanggi10@gmail.com  $white           #"
echo -e $red"         # $white greetz :In Crust We Rush - Insulinder Team $red#"
echo -e $white"         # $white copyright : ./MrX & NoXLaw & NoXAzka     $white                #"
echo -e $red"         # $white thanks to : NoiseCrust - Bad People $red             #"
echo -e $white"         ***********************************************"
echo ""
...
echo -e $green" 44) ReadMe"
echo -e $white""
read -p "[noxlaw@Tools]> " act;
...
sleep 1
echo -e $green" jangan coli mulu cuk "
sleep 1
echo -e $green" Please Wait.... "
sleep 1
echo -e $green" contact : islahelanggi10@gmail.com "
sleep 1
echo -e $red" fb : https://m.facebook.com/kartu.perdana.526 "
sleep 1
echo -e $red" Whatsapp : 085290666745 "
sleep 1
exit
fi
